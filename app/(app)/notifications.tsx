...
const styles = StyleSheet.create({
  ...
  metricsGrid: { marginTop: 12, flexDirection: 'row', flexWrap: 'wrap', gap: 11 },
  ...
  cloudPanel: { marginBottom: 12, padding: 12, borderRadius: 15, backgroundColor: 'rgba(43,82,67,0.68)', borderWidth: 1, borderColor: 'rgba(194,224,169,0.2)' },
  ...
  climateGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 11 },
