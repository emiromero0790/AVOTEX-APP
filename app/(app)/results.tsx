...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: '#43B6C6', padding: 22, paddingTop: 28 }, brand: { flexDirection: 'row', alignItems: 'center', gap: 8 }, eyebrow: { color: '#EAFBFD', fontFamily: 'Poppins_600SemiBold', fontSize: 11, letterSpacing: 1.4 }, title: { color: '#fff', fontFamily: 'Poppins_600SemiBold', fontSize: 25, marginTop: 18 }, subtitle: { color: '#F2FCFD', fontFamily: 'Poppins_400Regular', fontSize: 13, marginTop: 3 },
  ...
  metrics: { flexDirection: 'row', marginHorizontal: 16, gap: 10 }, metric: { flex: 1, backgroundColor: '#fff', borderRadius: 15, padding: 14 }, metricValue: { color: '#14B8A6', fontFamily: 'Poppins_600SemiBold', fontSize: 20 }, card: { backgroundColor: '#fff', borderRadius: 18, margin: 16, marginBottom: 0, padding: 16 }, cardTitle: { flexDirection: 'row', gap: 8, alignItems: 'center' }, bars: { height: 125, flexDirection: 'row', alignItems: 'flex-end', gap: 5, marginTop: 15 }, barColumn: { flex: 1, alignItems: 'center', justifyContent: 'flex-end', height: '100%' }, bar: { width: '70%', borderRadius: 5 }, barLabel: { color: '#94A3B8', fontSize: 9, marginTop: 4 }, distribution: { flexDirection: 'row', justifyContent: 'space-between', borderBottomWidth: 1, borderBottomColor: '#E5E7EB', paddingVertical: 9 }, count: { color: '#374151', fontFamily: 'Poppins_600SemiBold' },
