...
export default function ResultsScreen() {
  ...
  const colors = useMemo(() => ({
    ...
    accent: isColorblindMode ? '#3B82C4' : '#14B8A6',
...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: '#14B8A6', padding: 22, paddingTop: 28 }, brand: { flexDirection: 'row', alignItems: 'center', gap: 8 }, eyebrow: { color: '#E6FFFB', fontFamily: 'Poppins_600SemiBold', fontSize: 11, letterSpacing: 1.4 }, title: { color: '#fff', fontFamily: 'Poppins_600SemiBold', fontSize: 25, marginTop: 18 }, subtitle: { color: '#E6FFFB', fontFamily: 'Poppins_400Regular', fontSize: 13, marginTop: 3 },
  navigator: { flexDirection: 'row', margin: 16, padding: 4, borderRadius: 16, backgroundColor: '#E1F2EF', gap: 3 }, navItem: { flex: 1, minHeight: 46, borderRadius: 12, alignItems: 'center', justifyContent: 'center', gap: 2 }, navText: { color: '#14B8A6', fontFamily: 'Poppins_600SemiBold', fontSize: 10, textAlign: 'center' }, navTextActive: { color: '#fff' },
  heading: { fontFamily: 'Poppins_600SemiBold', color: '#14B8A6', fontSize: 21, marginHorizontal: 18, marginTop: 8 }, headingSmall: { fontFamily: 'Poppins_600SemiBold', color: '#14B8A6', fontSize: 14 }, body: { fontFamily: 'Poppins_400Regular', color: '#52606D', fontSize: 12, lineHeight: 19 }, muted: { color: '#718096', fontFamily: 'Poppins_400Regular', fontSize: 11 }, chips: { paddingHorizontal: 18, gap: 8, paddingVertical: 14 }, chip: { borderRadius: 18, paddingHorizontal: 14, paddingVertical: 8, backgroundColor: '#fff' }, chipText: { color: '#14B8A6', fontFamily: 'Poppins_600SemiBold', fontSize: 11 }, chipTextActive: { color: '#fff' },
  subheading: { marginHorizontal: 18, marginTop: 20, marginBottom: 2, fontFamily: 'Poppins_600SemiBold', color: '#14B8A6', fontSize: 17 },
  metrics: { flexDirection: 'row', marginHorizontal: 16, gap: 10 }, metric: { flex: 1, backgroundColor: '#fff', borderRadius: 15, padding: 14 }, metricValue: { color: '#14B8A6', fontFamily: 'Poppins_600SemiBold', fontSize: 20 }, card: { backgroundColor: '#fff', borderRadius: 18, margin: 16, marginBottom: 0, padding: 16 }, cardTitle: { flexDirection: 'row', gap: 8, alignItems: 'center' }, bars: { height: 125, flexDirection: 'row', alignItems: 'flex-end', gap: 5, marginTop: 15 }, barColumn: { flex: 1, alignItems: 'center', justifyContent: 'flex-end', height: '100%' }, bar: { width: '70%', borderRadius: 5 }, barLabel: { color: '#A1B3AF', fontSize: 9, marginTop: 4 }, distribution: { flexDirection: 'row', justifyContent: 'space-between', borderBottomWidth: 1, borderBottomColor: '#EEF3F1', paddingVertical: 9 }, count: { color: '#14B8A6', fontFamily: 'Poppins_600SemiBold' },
  ...
  planIntro: { marginHorizontal: 18, marginTop: 4 }, calendar: { margin: 16, marginBottom: 0, backgroundColor: '#fff', borderRadius: 18, padding: 13 }, calendarHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }, calendarMonth: { color: '#14B8A6', fontFamily: 'Poppins_600SemiBold', fontSize: 13, textTransform: 'capitalize' }, week: { flexDirection: 'row', justifyContent: 'space-between' }, day: { width: 38, minHeight: 57, borderRadius: 13, alignItems: 'center', justifyContent: 'center' }, dayName: { color: '#718096', fontFamily: 'Poppins_600SemiBold', fontSize: 10, textTransform: 'uppercase' }, dayNumber: { color: '#14B8A6', fontFamily: 'Poppins_600SemiBold', fontSize: 13, marginTop: 3 }, dayDot: { width: 4, height: 4, borderRadius: 2, marginTop: 3 }, selectedDate: { marginHorizontal: 18, marginTop: 13, color: '#14B8A6', fontFamily: 'Poppins_600SemiBold', fontSize: 13, textTransform: 'capitalize' }, form: { backgroundColor: '#fff', margin: 16, padding: 14, borderRadius: 16, gap: 9 }, formDate: { color: '#14B8A6', fontFamily: 'Poppins_600SemiBold', fontSize: 11, textTransform: 'capitalize' }, input: { borderWidth: 1, borderColor: '#D5E9E4', borderRadius: 10, padding: 11, fontFamily: 'Poppins_400Regular', fontSize: 12 }, smallButton: { alignSelf: 'flex-end', paddingHorizontal: 14, paddingVertical: 10, borderRadius: 10 }, task: { flexDirection: 'row', alignItems: 'center', gap: 11, backgroundColor: '#fff', marginHorizontal: 16, marginBottom: 8, padding: 14, borderRadius: 15 }, check: { width: 23, height: 23, borderRadius: 12, borderWidth: 1.5, borderColor: '#14B8A6', alignItems: 'center', justifyContent: 'center' }, done: { textDecorationLine: 'line-through', color: '#8CA09C' }, emptyTasks: { marginHorizontal: 16, marginBottom: 8, padding: 20, alignItems: 'center', backgroundColor: '#EAF4FC', borderRadius: 15 }, scanLink: { flexDirection: 'row', alignItems: 'center', gap: 9, margin: 20 }, empty: { alignItems: 'center', padding: 50 }, emptyTitle: { color: '#14B8A6', fontFamily: 'Poppins_600SemiBold', fontSize: 15, textAlign: 'center' }, center: { flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: '#F5F8F7' },
});