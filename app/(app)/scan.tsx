...
export default function Scan() {
  ...
  // --- FUNCIÓN SIMPLIFICADA: Ahora solo guarda los datos de texto/numéricos ---
  const saveScanResult = async (predictionData: { label: string; score: number }) => {
    ...
    try {
      // 1. Preparar el registro para la base de datos (SIN la URL de la imagen)
      const scanRecord = {
        user_id: user.uid,
      ...
      // 2. Insertar el registro en la tabla "scans"
