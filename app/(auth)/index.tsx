...
const s = StyleSheet.create({
  ...
  brandLogo: { width: 180, height: 64, tintColor: '#FFFFFF' },
  glassPanel: {
  ...
  panelHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', minHeight: 48 },
  panelLogo: { width: 170, height: 52 },
